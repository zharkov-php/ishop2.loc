...
function CheckAuthentication($drupal_path) {
    ...
    if (!isset($authenticated)) {
        ...
        if (!isset($bootstrap_file_found) || $bootstrap_file_found) {
            ...
            if (user_access('access kcfinder-3.12')) {
                ...
                global $user;
                $_SESSION['KCFINDER']['uploadURL'] = strtr(variable_get('kcfinder_upload_url', 'sites/default/files/kcfinder-3.12'), array('%u' => $user->uid, '%n' => $user->name));
