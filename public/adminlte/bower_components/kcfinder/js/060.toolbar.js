...
_.initToolbar = function() {
    ...
    $('#toolbar a[href="kcact:about"]').click(function() {
        var html = '<div class="box about">' +
            '<div class="head"><a href="http://kcfinder-3.12.sunhater.com" target="_blank">KCFinder</a> ' + _.version + '</div>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (_.version < data.version)
                        span.html('<a href="http://kcfinder-3.12.sunhater.com/download" target="_blank">' + _.label("Download version {version} now!", {version: data.version}) + '</a>');
                    else
